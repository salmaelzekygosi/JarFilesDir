...
/// <summary>
/// Configures SASL/PLAIN authentication for .NET clients.
/// </summary>
public class SaslPlainAuthHandler : IAuthenticationHandler
{
    private readonly string _username;
    private readonly string _password;
    private readonly bool _useTls;

    public SaslPlainAuthHandler(string username, string password, bool useTls)
    {
